...
var budgetController = (function () {
    //create expense and income function
    class Expense {
    ...
    //store income / expense data in arrays
    var data = {
        allItems: {
            exp: [],
            inc: []
    ...
    return {
        ...
        //devare item from the budget controller
        ...
        //calculate percentages in the budget controller
...
var controller = (function(budgetCtrl, UICtrl) {
    ...
    var ctrlDevareItem = function(event) {
        ...
        if (itemID) {
            ...
            //devare item from data structure
            budgetCtrl.devareItem(type, ID);

            //devare item from user interface
